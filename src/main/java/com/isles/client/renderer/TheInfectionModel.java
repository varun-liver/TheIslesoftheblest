...
public class TheInfectionModel extends HierarchicalModel<TheInfectionEntity> {
	...
	public static final ModelLayerLocation LAYER_LOCATION =
			new ModelLayerLocation(ResourceLocation.fromNamespaceAndPath(blest.MODID, "the_infection"), "main");
	...
	public void setupAnim(TheInfectionEntity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
		...
		this.animate(entity.attackAnimationState, TheInfectionAnimation.attack1, ageInTicks, 1.0F);
		this.animate(entity.attack2AnimationState, TheInfectionAnimation.attack2, ageInTicks, 1.0F);
		this.animateWalk(TheInfectionAnimation.walk, limbSwing, limbSwingAmount, 2.0F, 2.5F);
	}
