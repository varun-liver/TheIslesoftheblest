...
public class blest {
    ...
    // Creates a new Block with the id "theislesoftheblest:example_block", combining the namespace and path
    public static final RegistryObject<Block> EXAMPLE_BLOCK = BLOCKS.register("example_block", () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.STONE)));
    // Creates a new BlockItem with the id "theislesoftheblest:example_block", combining the namespace and path
